...
export default function Loader() {
  ...
  return (
    <div className="opacity-70 w-full max-w-[800px]">
      <div
        ref={containerRef}
        className="text-white overflow-hidden relative h-20 border-b pb-2 border-white flex items-end"
      >
        <motion.div className="absolute bottom-0 text-7xl" animate={controls}>
