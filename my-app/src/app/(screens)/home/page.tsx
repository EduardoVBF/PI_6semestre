      ...
      try {
        ...
        const getErrorMessage = (e: unknown): string => {
          ...
          if (typeof e === "object" && e !== null) {
            ...
            const response = eObj.response as
    ...
    const userInfo = async () => {
      ...
      try {
        const response = await api.get(
          `/api/v1/users/email/${session.user?.email}`,
          {
            headers: {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      {userType && userType !== "adm" ? (
        <main className="flex-grow px-4 md:px-8 py-4 flex items-center justify-center">
                  ...
                  <div className="flex w-full justify-between">
                    ...
                    <p className="text-sm text-white font-bold">
                      {dashboard.veiculoMaisEconomico.consumo !== null
                        ? Number(
                            dashboard.veiculoMaisEconomico.consumo
                          ).toFixed(2)
                        : "--"}{" "}
                      Km/L
                    </p>
                  ...
                  <div className="flex w-full justify-between">
                    ...
                    <p className="text-sm text-white font-bold">
                      {dashboard.veiculoMaisConsome.consumo !== null
                        ? Number(dashboard.veiculoMaisConsome.consumo).toFixed(
                            2
                          )
                        : "--"}{" "}
                      Km/L
